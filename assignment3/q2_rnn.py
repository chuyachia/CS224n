...
class RNNModel(NERModel):
    ...
    def add_loss_op(self, preds):
        ...
        """
        ### YOUR CODE HERE (~2-4 lines)
        loss_temp = tf.nn.sparse_softmax_cross_entropy_with_logits(labels= self.labels_placeholder,logits= preds)
        loss_temp = tf.boolean_mask(loss_temp,self.mask_placeholder)
